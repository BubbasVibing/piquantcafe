        ...
        <div className="container">
          <div className="contact-info-grid">
            <div className="contact-info-card">
              <a href="https://maps.google.com/?q=1444+NJ-73,+Pennsauken,+NJ+08110" target="_blank" rel="noopener noreferrer" className="contact-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="#471f3a">
                  <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/>
                </svg>
              </a>
              <h3>Visit Us</h3>
              <p>1444 NJ-73<br />Pennsauken, NJ 08110</p>
              <a href="https://maps.google.com/?q=1444+NJ-73,+Pennsauken,+NJ+08110" target="_blank" rel="noopener noreferrer" className="info-link">Get Directions</a>
            </div>
            <div className="contact-info-card">
            ...
            <div className="contact-info-card">
              <a href="tel:+16096820755" className="contact-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="#471f3a">
                  <path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/>
                </svg>
              </a>
              <h3>Call Us</h3>
              <p>(609) 682-0755</p>
              <a href="tel:+16096820755" className="info-link">Call Now</a>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="hours-content">
            <div className="hours-text">
              ...
              <ul className="hours-list">
                <li><span className="day">Monday - Saturday:</span> <span className="time">11 AM - 5 PM</span></li>
                <li><span className="day">Sunday:</span> <span className="time">11 AM - 4 PM</span></li>
              </ul>
            </div>
            <div className="hours-image">
              <img src={secondInteriorImage} alt="Inside Piquant Café" />
            </div>
          </div>
        </div>
      </section>
